...
<t:skeleton headerImports="${PageHeader}" notes="${Notifications}" user="${User}" title="${Title}About - " contextPath="${contextPath}">
    ...
    <ol>
        ...
        so do feel free to <a href="${contextPath}/contact.html">contact us</a> if anything is unclear.
        </li>
        <li>
        ...
        (the <img src="${contextPath}/res/js/visualizers/editMetadata/editMetadata.png"/> icon).
        ...
        <i>Contact the Web Lab team.</i>
            ...
            <a href="${contextPath}/contact.html">contact us</a> and we will attempt to determine the cause.
        </li>
    </ol>
</t:skeleton>
