...
<t:skeleton headerImports="${PageHeader}" notes="${Notifications}" user="${User}" title="${Title}Contact - " contextPath="${contextPath}">
    <h1>Contact</h1>
    <p>
        Please direct queries about this website to <a href="mailto:jonathan.cooper@cs.ox.ac.uk?subject=Functional%20Curation%20Website&cc=gary.mirams@cs.ox.ac.uk">Jonathan Cooper</a>.
    </p>
    <p>
